...
{    
    ...
    std::string link = "fast";
    LINK_TYPE link_type;
    
    bool tracing = true;
    std::string prefix_file_name = "TcpCongestion";
    uint16_t nFlows = 3;
    bool pcap = true;
    ...
    ftp.SetAttribute("OnTime", StringValue("ns3::ConstantRandomVariable[Constant=20.0]"));
    ftp.SetAttribute("OffTime", StringValue("ns3::ConstantRandomVariable[Constant=0.0]"));
    ftp.SetAttribute("PacketSize", UintegerValue(1024));
    ftp.SetAttribute("DataRate", DataRateValue(DataRate(1638400)));
